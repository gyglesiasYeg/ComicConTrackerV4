...
async function json(url){const r=await fetch(url,{headers:{'user-agent':'ComicConTracker/9.2','accept':'application/json'}});if(!r.ok)throw new Error('HTTP '+r.status);return r.json()}
